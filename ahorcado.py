...
""" 
    El juego comienza con una horca vacía y palabras divididas por caracter
    ...
    Las palabras son randoms de un conjunto definido.
"""
...
def palabra_random():
    # nos retorna un elemento random de la lista
    ...
    while True:
        ...
        while len(letra_ingresada) != 1 or not letra_ingresada.isalpha():
            letra_ingresada = input(
                'Escoge una letra valida [A...z]: ').lower()
        ...
        if len(letras_correcta) == 0:
            ...
            if intentos_fallidos == 7:
                notificarGameOver(palabra, palabra_escondida,
                                  intentos_fallidos)
                break
        else:
            # si letras_correctas no es vacio, significa que tengo alguna
            for idx in letras_correcta:
                # itero a través de todas las letras correctas que tenga y añado en palabras_escondidas ...
                # ... la letra correcta en su correspondiente lugar/indice
