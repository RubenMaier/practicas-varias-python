...
import turtle # importo una librería que me permite generar graficas de ventana
...
dave.left(90) # roto el angulo de movimiento 90 grados, es decir, proximo movimiento será hacia arriba
...
turtle.mainloop() # lo coloco para que la ventana no se me cierre apenas finalice la animación